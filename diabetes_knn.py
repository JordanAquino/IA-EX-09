import pandas as pd
url = 'https://raw.githubusercontent.com/JordanAquino/IA-EX-09/main/diabetes.csv'
base_Treinamento = pd.read_csv(url)

"""Importação da base de teste"""

url_teste = 'https://raw.githubusercontent.com/JordanAquino/IA-EX-09/main/diabetes.csv'
base_teste = pd.read_csv(url_teste)

"""Importação da base de treinos"""

url_treino = 'https://raw.githubusercontent.com/JordanAquino/IA-EX-09/main/diabetes.csv'
